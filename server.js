...
app.post('/subscribe', (req, res) => {
  const sub = req.body;
  const exists = subscriptions.some(item => JSON.stringify(item) === JSON.stringify(sub));
...
app.post('/unsubscribe', (req, res) => {
  const sub = req.body;
  subscriptions = subscriptions.filter(item => JSON.stringify(item) !== JSON.stringify(sub));
